    ...
    const newsTopics = [
    {
        ...
        image: 'https://static.wixstatic.com/media/c2bed181787047f0854890bb489c9662.jpg/v1/fill/w_1000,h_667,al_c,q_85,usm_0.66_1.00_0.01/c2bed181787047f0854890bb489c9662.jpg',
        newsUrl: '/news/water',
    },
    {
        id: 'roads',
    ...
    return (
        ...
        >
        <h2 style={{ color: '#333', marginBottom: 24, textAlign: 'center' }}>
        ...
        >
            ...
            <div
                key={topic.id}
                onClick={() => handleCardClick(topic.newsUrl)}
                ...
                tabIndex={0}
                role="button"
                aria-pressed={flippedCard === topic.id}
                aria-label={`View latest news about ${topic.title}`}
                onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                    e.preventDefault();
                    handleCardClick(topic.newsUrl);
                }
                }}
                style={{
                perspective: 1000,
            ...
            >
                ...
                style={{
                    ...
                    textAlign: 'center',
                    transition: 'transform 1s cubic-bezier(.4,0,.2,1), box-shadow 0.3s ease', // slower flip
